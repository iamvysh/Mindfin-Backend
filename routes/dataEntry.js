...
import { bulkUploadLeads, deleteLead, exportLeads, getALeadByID, getAllLeads, updateLead, deleteAllLeads } from "../controller/leads/leadController.js";
...
router.delete("/delete-all-leads", tryCatchMiddleware(deleteAllLeads))

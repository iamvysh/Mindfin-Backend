...
export const addEmployee = async (req,res,next) =>{
    ...
    const newEmployee = new employeeModel({
        ...
        ...req.body // Spread the rest of the request body fields
    });
    ...
    <body>
        <div class="container">
            <div class="email-content">
                <div class="header"><h1>KINGSTER</h1></div>
...
`;
    ...
    sendResponse(res,200,"Employee added successfully")
    ...
    //     "salary": 60000,
    //     "salaryStartDate": "2023-02-01",
    //     "salaryEndDate": null,
    //     "attendenceLoacation": "Mumbai Office",
    //     "bioMetricIp": "192.168.1.10",
    //     "appointmentLetter": ["https://example.com/appointment.pdf"],
    //     "salarySlip": ["https://example.com/salaryslip.pdf"],
    //     "relivingLetter": [],
    //     "experienceLetter": [],
